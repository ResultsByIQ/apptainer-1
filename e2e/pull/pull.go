...
var tests = []testStruct{
	...
	// --allow-unauthenticated tests
	{
		...
		srcURI:           "oras://ghcr.io/apptainer/alpine:3.15.",
	...
	// test version specifications
	{
		...
		srcURI:           "oras://ghcr.io/apptainer/alpine:sha256.03883ca565b32e58fa0a496316d69de35741f2ef34b5b4658a6fec04ed8149a8",
		unauthenticated:  true,
		expectedExitCode: 0,
	},
	{
...
func (c ctx) testPullUmask(t *testing.T) {
	...
	for _, tc := range umaskTests {
		...
		cmdArgs = append(cmdArgs, tc.imagePath, "oras://ghcr.io/apptainer/alpine")
